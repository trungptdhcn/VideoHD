 ...
 */
package com.taa.videohd.ui.customview.player;
        ...
        MetadataRenderer<Map<String, Object>>, DebugTextViewHelper.Provider
{
    ...
    private final CustomPlayListControl playListControl;
    ...
    public DemoPlayer(RendererBuilder rendererBuilder)
    {
        ...
        playListControl = new CustomPlayListControl(player);
    ...
    public CustomPlayListControl getPlayListControl()
    {
